...
export const URL = 'https://www.nachrichten.at/sport/fussball/unterhaus/2022_2023/1_klasse/1nw/kopfing'
...
const getMatchesContent2 = async () => {
  const browser = await puppeteer.launch({
    slowMo: 250 // slow down by 250ms
  });
  const page = await browser.newPage();
